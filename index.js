 ...
 * @property {Object}  [defaults] - common method call options that will be included with every call (ex: set default token), these options can be override on a per call basis
 */
    ...
    return {
        ...
        async checkIfServiceRegistered (svcIdOrName) {
            ...
            return agentServiceListR
                && Object.values(agentServiceListR).some(({ ID: i, Service: s }) => i === svcIdOrName || s === svcIdOrName);
        },
